...
public class addmem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(VAL, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, 280, 20));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/addmem/addmember.png"))); // NOI18N
    ...
    private void addbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbtnActionPerformed
        ...
        boolean isValid = emailval.emai1_Validation(emailtxt.getText());
        if(isValid == false){
            VAL.setText("EMAIL NOT VALID ");
        }
        ...
        if(idtxt.getText().equals("")|| nametxt.getText().equals("")|| agetxt.getText().equals("")|| emailtxt.getText().equals("")|| numtxt.getText().equals("") ) {
           // VAL.setText("Email Adress Not Valid !");
            ...
            //String data[] = {idtxt.getText(),nametxt.getText(),agetxt.getText(),emailtxt.getText(),numtxt.getText()};
            String nameis = nametxt.getText();
            String idis = idtxt.getText();
            String ageis = agetxt.getText();
            String emailis = emailtxt.getText();
            String numis = numtxt.getText();
            VAL.setText("");
            
            //String birthis = birth.getDate().toString();
            DateFormat df = new SimpleDateFormat("dd-MM-yyyy");
             String birthis = df.format(birth.getDate());
        ...
        try {
            ...
            Writer.write(""+idis+";;"+nameis+";;"+ageis+";;"+emailis+";;"+numis+";;"+birthis+"");
